...
var onClickAdd = function onClickAdd() {
  ...
  createIncmopleteList(inputText);
}; // 未完了リストから指定の要素を削除


var deleteFromIncompletList = function deleteFromIncompletList(target) {
  document.getElementById("incomplete-list").removeChild(target);
}; // 未完了リストに追加する関数


var createIncmopleteList = function createIncmopleteList(text) {
  // div生成
  ...
  completeButton.addEventListener("click", function () {
    ...
    deleteFromIncompletList(completeButton.parentNode); // 完了リストに追加する要素
    ...
    backButton.addEventListener("click", function () {
      ...
      document.getElementById("complete-list").removeChild(deleteTarget); // テクストを取得

      var text = backButton.parentNode.firstElementChild.innerText;
      createIncmopleteList(text);
    }); // divタグの子要素に各要素を設定
  ...
  deleteButton.addEventListener("click", function () {
    ...
    deleteFromIncompletList(deleteButton.parentNode);
  }); // divタグの子要素に各要素を設定
